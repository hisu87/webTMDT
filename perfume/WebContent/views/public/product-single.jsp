			...
			<%@page import="models.Perfume" %>
				<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8"
					...
					<%@include file="/templates/public/inc/header.jsp" %>
						...
						<% if(request.getAttribute("product") !=null){ Perfume product=(Perfume)
								...
								<div class="container">
									<ul class="breadcrumb">
										...
										<li class="dropdown active breadcrumb-search">
											<a href="#" id="one" data-toggle="dropdown">
												<%=product.getPerfumes()%>
											</a>
										</li>
									</ul>
									...
									<div class="single-container">
										<div class="product-single">
											<div class="featured-box">
												<div class="row">
													<div class="col-sm-5">
														<% if(request.getAttribute("picID") !=null){ Picture
															picID=(Picture) request.getAttribute("picID"); %>
															<figure class="image">
																<img src="<%=request.getContextPath()%>/uploads/images/product/<%=picID.getPicture() %>"
																	alt="image" style="width:100%;height:300px">
																<figcaption>
																	<a href="#product-more" data-toggle="collapse">Ẩn
																		bớt <i class="flaticon-small63"></i></a>
																</figcaption>
															</figure>
															<% }else{ %>
																<figure class="image">
													...
													<div class="col-sm-7">
														<div class="text">
															<input class="" id="idpro" name="idpro" type="hidden"
																value="<%=product.getId()%>" />
															<p>Thương hiệu: <a href="#" class="text-primary">
																	<%=product.getBrand()%>
																</a></p>
															<h4>
																<%=product.getPerfumes()%>
															</h4>
															<p>Lượt xem: <%=product.getViews() %>
															</p>
															<div id="info-1" class="collapse in">
																...
																<a idPro="<%=product.getId() %>"
																	href="javascript:void(0)"
																	class="btn btn-default add-to-card">Thêm vào giỏ
																	hàng</a>
															</div>
														</div>
													</div>
										...
										<% if(request.getAttribute("ortherProList") !=null){ List<Perfume> ortherProList
											= (List<Perfume>)request.getAttribute("ortherProList");
												if(ortherProList.size() > 0){
												%>
												<div class="other-products">
													<header class="heading">
														<span class="caro-prev other-prev"><i
																class="flaticon-arrowhead7"></i></span>
														<span class="caro-next other-next"><i
														...
														<% for(Perfume objOther : ortherProList){ %>
															<div class="item">
																<div class="thumbnail thumbnail-product">
																	<% if(request.getAttribute("picPro"+objOther.getId())
																		!=null){ Picture picPro=(Picture)
																		request.getAttribute("picPro"+objOther.getId());
																		%>
																		<figure class="image-zoom">
																			<img alt="image"
																				src="<%=request.getContextPath()%>/uploads/images/product/<%=picPro.getPicture()%>">
																		</figure>
																		<% }else{ %>
																			<figure class="image-zoom">
																				<img alt="image"
																					src="<%=request.getContextPath()%>/templates/public/images/noimage.gif">
																			</figure>
																			<% } %>

																				<div class="caption text-center">
																					<h5><a href="#">
																							<%=objOther.getPerfumes() %>
																						</a></h5>
																...
																<div class="row">
																	<div class="col-sm-6">
																		<div class="prod-desc-box">
																			...
																			<h5>Loại sản phẩm</h5>
																			<p>
																				<%=product.getCatPer().getCatPerfume()%>
																			</p>
					                    ...
					                    <span class="glyphicon glyphicon-off"></span> Logout                    
																	...
																	<div class="comment-tabs">
																		<ul class="nav nav-tabs" role="tablist">
																			<li class="active"><a
																					href="#comments-logout" role="tab"
																					data-toggle="tab">
																					<h4 class="reviews text-capitalize">
																						Mọi người</h4>
																				</a></li>
																			<li><a href="#add-comment" role="tab"
																					data-toggle="tab">
																					<h4 class="reviews text-capitalize">
																						Bình luận của bạn</h4>
																				</a></li>
																		</ul>
																		<div class="tab-content">
																			<div class="tab-pane active"
																				...
																				<ul class="media-list">
																					<!-- Kết quả comment -->
																					<% if(session.getAttribute("listCMT")
																						!=null){ List<Comment> listCmt =
																						(List<Comment>
																							)session.getAttribute("listCMT");
																							for(Comment objCMT :
																							listCmt){
																							%>
																							<li class="media">
		     		                              ...
		     		                              <a class="btn btn-warning btn-circle text-uppercase" data-toggle="collapse" href="#replyThree"><span class="glyphicon glyphicon-comment"></span> 2 comments</a> -->
																			...
																			<div class="tab-pane" id="add-comment">
																				<form class="form-horizontal"
																					...
																					<div class="form-group">
																						<label for="email"
																							class="col-sm-2 control-label">Nội
																							dung</label>
																						<div class="col-sm-10">
																							<textarea
																								class="form-control"
